...
## 2026-09-24 · Primera compilación local Android con Fastlane

- Configurado Fastlane 2.240.1 con dependencias fijadas, compilación local Gradle y tareas separadas de verificación/subida interna. Instrucciones en `docs/FASTLANE.md`. No se ha configurado ni ejecutado todavía el flujo iOS con GitHub Actions.
- Reutilizada la firma Android existente de EAS. Claves almacenadas fuera de Git; Fastlane accede a Google Play mediante la cuenta de servicio existente. La consulta previa devuelve código 12 en interno y 15 en producción, sin versiones en alpha/beta.
- Android 1.5.0 (16) compilado localmente con Node 22.23.3, JDK 17, SDK 36 y NDK 27.1.12297006. Incluye las correcciones de scroll y adaptación del halo de `13ba842`. Gradle completó la compilación en 6 min 54 s; sin EAS Build ni minutos de GitHub Actions.
- AAB: `build-artifacts/meditation-timer-1.5.0-16.aab`. SHA-256: `87f006acd95c9fa5311bc446910ba1144e15884a8eec86959a9dd1082807e5af`.
- Verificado el AAB real con bundletool, jarsigner y keytool: paquete y versión correctos, firma de subida existente (SHA-256 `7e6f9ffd9251ce7c03de39ea8c9e679137ff9395a7aa0c3deabcacc9d4512ecd`), no depurable, sin RECORD_AUDIO ni SYSTEM_ALERT_WINDOW, permiso de alarmas exactas y RestoreFocusReceiver presentes, mapping R8 incluido, ocho M4A y gong idénticos a sus fuentes, splash `#181613`.
